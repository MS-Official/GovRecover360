...
class Settings(BaseSettings):
    ...
    WSO2_APIM_ENABLED: bool = False
    WSO2_GATEWAY_URL: str | None = None
    WSO2_PUBLISHER_URL: str | None = None
    WSO2_ISSUER: str | None = None
    WSO2_AUDIENCE: str | None = None
    WSO2_JWKS_URL: str | None = None
    WSO2_INTROSPECTION_URL: str | None = None
    WSO2_CLIENT_ID: str | None = None
    WSO2_CLIENT_SECRET: str | None = None
    SUPERSET_URL: str | None = None
    GEONODE_ENABLED: bool = False
    GEONODE_URL: str | None = None
    GEONODE_USERNAME: str | None = None
    GEONODE_PASSWORD: str | None = None
