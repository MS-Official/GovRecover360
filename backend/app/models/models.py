...
APPLICATION_STATUSES = ['DRAFT', 'SUBMITTED', 'UNDER_VERIFICATION', 'VERIFIED', 'REJECTED', 'APPROVED_FOR_RELIEF', 'PAYMENT_PENDING', 'PAYMENT_APPROVED', 'DISPATCH_PENDING', 'DISPATCHED', 'COMPLETED']
